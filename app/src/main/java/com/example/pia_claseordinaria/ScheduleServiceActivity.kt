...
import com.example.pia_claseordinaria.ui.screens.ScheduleServiceScreen
...
class ScheduleServiceActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val viewModel = CondoViewModel()
        setContent {
            HousePortTheme {
                ScheduleServiceScreen(viewModel) { finish() }
            }
        }
    }
}
